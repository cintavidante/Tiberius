...
direc = os.path.join(pwd, 'cosmics/plots_{}_{}_sigma'.format(args.file_type, args.pixel_clip))
...
def replace_cosmics(cosmic_pixels,medians,science_list,nints,jwst=False):
    ...
    cleaned_direc = os.path.join(pwd, "cosmics/cleaned_fits_{}_{}_sigma".format(args.file_type, args.pixel_clip))
